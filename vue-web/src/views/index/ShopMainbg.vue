      ...
      <div class="am-g am-g-fixed recommendation">
        ...
        <div class="am-u-sm-4 am-u-lg-3" v-for="ad in adverses">
          <div class="info">
            ...
            <div @click="toIntroduction(ad.spuId)" class="recommendationMain one" style="cursor:pointer">
...
<script>
import { queryAdvertisement } from '@/api/advertisement'
export default {
  name: 'ShopMainbg',
  data() {
    return {
