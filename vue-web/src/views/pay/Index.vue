      ...
      <div class="paycont">
        <div class="address">
          ...
          <ul>
            ...
            <li v-for="item in addressList" class="user-addresslist defaultAddr">
        ...
        <div class="logistics">
          ...
          <ul class="op_express_delivery_hot">
            ...
            ><i
              ...
              ></i>韵达<span></span></li>
            <li
              data-value="zhongtong"
              class="OP_LOG_BTN op_express_delivery_hot_last "
            ><i
                class="c-gap-right"
            ...
            <li
              data-value="shunfeng"
              class="OP_LOG_BTN  op_express_delivery_hot_bottom"
            ><i
                class="c-gap-right"
        ...
        <div class="logistics">
          <h3>选择支付方式</h3>
          <ul class="pay-list">
            <li class="pay card"><img src="@/assets/images/wangyin.jpg">银联<span></span></li>
            <li class="pay qq"><img src="@/assets/images/weizhifu.jpg">微信<span></span></li>
            <li class="pay taobao"><img src="@/assets/images/zhifubao.jpg">支付宝<span></span></li>
          </ul>
        </div>
        <div class="clear"></div>
...
<script>
import { queryAddress } from '@/api/item'
