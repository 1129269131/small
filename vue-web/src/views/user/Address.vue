              ...
              <div class="am-form-group">
                ...
                <div class="am-form-content address">
                  ...
                  <div
                    ...
                    id="am-selected-zdzqx"
                    data-am-dropdown=""
                  > <button
                      type="button"
                      class="am-selected-btn am-btn am-dropdown-toggle am-btn-default"
                    > <span class="am-selected-status am-fl">湖北省</span> <i class="am-selected-icon am-icon-caret-down"></i> </button>
                    <div class="am-selected-content am-dropdown-content">
                      ...
                      <ul class="am-selected-list">
                        <li
                          ...
                          data-group="0"
                          data-value="a"
                        > <span class="am-selected-text">浙江省</span> <i class="am-icon-check"></i></li>
                        <li
                          class="am-checked"
                          data-index="1"
                          data-group="0"
                          data-value="b"
                        > <span class="am-selected-text">湖北省</span> <i class="am-icon-check"></i></li>
                      </ul>
                    ...
                    <div class="am-selected-content am-dropdown-content">
                      ...
                      <ul class="am-selected-list">
                        <li
                          ...
                          data-group="0"
                          data-value="a"
                        > <span class="am-selected-text">瑞安区</span> <i class="am-icon-check"></i></li>
                        <li
                          class="am-checked"
                          data-index="1"
                          data-group="0"
                          data-value="b"
                        > <span class="am-selected-text">洪山区</span> <i class="am-icon-check"></i></li>
                      </ul>
                      <div class="am-selected-hint"></div>
                    </div>
                  </div>
