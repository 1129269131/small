      ...
      <div class="ebill-section">
          ...
          <div class=" ng-scope">
            <div class="trade-circle-select  slidedown-">
              <a
                ...
                class="current-circle ng-binding"
              >2015/11/01 - 2015/11/30</a>
        ...
        <div class="module-income ng-scope">
          ...
          <div class="module-consumeTrend inner-module">
            ...
            <div
              id="consumeTrend-chart"
              class="consumeTrend-chart"
            >
            ...
            <div class="card-chart valid">
              <div class="cards-carousel">
                <div class="mask">
                  ...
                  <div
                    class="bank ng-binding"
                    style="background-image: url(../../assets/images/combo.png);"
                  >中国农业银行</div>
                  <div class="details">
                    <a>查看详情</a>
                  </div>
