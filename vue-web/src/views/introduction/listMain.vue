				...
				<div class="scoll">
					<section class="slider">
						...
						<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1000%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);"><li class="clone" aria-hidden="true" style="width: 0px; float: left; display: block;">
									<img src="@/assets/images/03.jpg" draggable="false">
								</li>
								<li style="width: 0px; float: left; display: block;" class="flex-active-slide">
									<img src="@/assets/images/01.jpg" title="pic" draggable="false">
								</li>
								<li style="width: 0px; float: left; display: block;">
									<img src="@/assets/images/02.jpg" draggable="false">
								</li>
								<li style="width: 0px; float: left; display: block;">
									<img src="@/assets/images/03.jpg" draggable="false">
								</li>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="#"><img src="@/assets/images/01_mid.jpg" alt="细节展示放大镜特效" rel="../images/01.jpg" class="jqzoom" style="cursor: crosshair;"></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="@/assets/images/01_small.jpg" mid="@/assets/images/01_mid.jpg" big="@/assets/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="@/assets/images/02_small.jpg" mid="@/assets/images/02_mid.jpg" big="@/assets/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="@/assets/images/03_small.jpg" mid="@/assets/images/03_mid.jpg" big="@/assets/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
							...
							<dl class="iteminfo_parameter freight">
								...
								<div class="iteminfo_freprice">
									<div class="am-form-content address">
										<el-select style="width:100px;margin-right:15px" v-model="value2" placeholder="福建省">
											<el-option
									...
									<div class="pay-logis" style="display:inline-block">
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="@/assets/images/hwbn40x40.jpg">
												<!-- 评论者头像 -->
											</a>
