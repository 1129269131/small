<template>
    <div>
			<SetPayPassword id="SetPayPassword"></SetPayPassword>
					<!--标题 -->
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								<img class="am-circle am-img-thumbnail" src="@/assets/images/user.jpg" alt="">
							</div>
						...
						<div class="check">
							<ul>
								...
								<li>
									...
									<div class="fore3">
											<div class="am-btn am-btn-secondary" @click="showChildrenModel('SetPayPassword')">立即启用</div>
									</div>
								</li>
								<li>
